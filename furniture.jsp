...
%>
	<table class="Ouab">
					...
					<table class="books_tab">
						...
						<tbody>
							<tr>
								...
								<span class="furniture-name"> bed |200$ <br> 
								</span>
								...
								<span class="furniture-name">small office |150$<br>
								</span>
								...
								<span class="furniture-name">wooden stand |90$ <br>
								</span>
							...
							<tr>
								...
								<span class="furniture-name">Rose decorative mirrors|60$<br>
								...
								<span class="furniture-name">desk chair |66$<br> 
								</span>
								...
								<th><img src="images/fu6.jpg"
									alt=" chair"><br>
								<span class="furniture-name">chair |59$<br>
		...
		try {
			...
			String Furnitureid = request.getParameter("var");
			if (Furnitureid == null) {
				Furnitureid = "0";
			...
			if ((Furnitureid.isEmpty() == false) || (Furnitureid.equals("0") == false)) {

				// checking if the user has added book with id $book_num to the cart or not
				sqlQuery = "SELECT * FROM cart WHERE furnitureid= " + Furnitureid + " AND username='" + username + "'";
				...
				if (num > 0) {
			sqlQuery = "Update cart set qty =  qty + 1 WHERE furnitureid= " + Furnitureid + " AND username='" + username + "'";
			preparedStmt = connection.prepareStatement(sqlQuery);
			...
			sqlQuery = "INSERT INTO cart (furnitureid, qty, username) VALUES (" + Furnitureid + ", 1,'" + username + "')";
			preparedStmt = connection.prepareStatement(sqlQuery);
			preparedStmt.execute();
